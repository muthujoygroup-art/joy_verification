...
CREATE TABLE IF NOT EXISTS candidates (
    ...
    specimen_signature TEXT,
    aadhaar_data JSONB DEFAULT '{}',
    pan_data JSONB DEFAULT '{}',
    bank_data JSONB DEFAULT '{}',
    dl_data JSONB DEFAULT '{}',
    epfo_data JSONB DEFAULT '{}',
    passport_data JSONB DEFAULT '{}',
    face_match_data JSONB DEFAULT '{}',
    court_record_data JSONB DEFAULT '{}',
