...
const mapCandidateDto = (c) => {
  ...
  return {
    ...
    nativeState: c.native_state || c.nativeState || jfd.nativeState || '',
    native_state: c.native_state || c.nativeState || jfd.nativeState || '',
    nativeDistrict: c.native_district || c.nativeDistrict || jfd.nativeDistrict || '',
    ...
    nominee_name: c.nominee_name || c.nomineeName || jfd.nomineeName || '',
    nomineeRelation: c.nominee_relation || c.nomineeRelation || jfd.nomineeRelation || '',
    nominee_relation: c.nominee_relation || c.nomineeRelation || jfd.nomineeRelation || '',
    nomineeDob: jfd.nomineeDob || c.nomineeDob || '',
    nomineeAge: jfd.nomineeAge || c.nomineeAge || '',
    nomineeAddress: jfd.nomineeAddress || c.nomineeAddress || '',
    nomineeShare: jfd.nomineeShare || c.nomineeShare || '100%',
    nomineeGuardian: jfd.nomineeGuardian || c.nomineeGuardian || '',
    insuranceDependents: jfd.insuranceDependents || c.insuranceDependents || '',
    ...
    // Form 16 / TDS Form 12B Particulars
    taxRegime: jfd.taxRegime || 'New Tax Regime (Section 115BAC)',
    previousGrossSalary: jfd.previousGrossSalary || '',
    previousPfDeducted: jfd.previousPfDeducted || '',
    previousPtDeducted: jfd.previousPtDeducted || '',
    previousTdsDeducted: jfd.previousTdsDeducted || '',
    ...
    contractorAgencyName: jfd.contractorAgencyName || '',
    clraLicenseNo: jfd.clraLicenseNo || '',
    employeeTicketNo: jfd.employeeTicketNo || '',
    wageRate: jfd.wageRate || '',
    contractDeploymentLocation: jfd.contractDeploymentLocation || '',
    contractPeriodFrom: jfd.contractPeriodFrom || '',
    contractPeriodTo: jfd.contractPeriodTo || '',

    // Professional & Social Links
    linkedInUrl: c.linked_in_url || c.linkedInUrl || jfd.linkedInUrl || '',
    ...
    experienceList: Array.isArray(c.experience_list) ? c.experience_list : (Array.isArray(c.experienceList) ? c.experienceList : (Array.isArray(jfd.experienceList) ? jfd.experienceList : [])),
    industrySpecialization: c.industry_specialization || c.industrySpecialization || jfd.industrySpecialization || {},
    statutoryFormsConfig: c.statutory_forms_config || c.statutoryFormsConfig || jfd.statutoryFormsConfig || {
      form11: true, form2: true, esicForm1: true, form16: true, formF: true, nda: true, posh: true, nonCompete: true, contractFormXIII: false
    },
    requiredDocumentsConfig: c.required_documents_config || c.requiredDocumentsConfig || jfd.requiredDocumentsConfig || {},
    
    specimenSignature: c.specimen_signature || c.specimenSignature || jfd.specimenSignature || null,
    specimen_signature: c.specimen_signature || c.specimenSignature || jfd.specimenSignature || null,
    customFields: cf,
    custom_fields: cf,
