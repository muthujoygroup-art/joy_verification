    ...
    <div className="w-full bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-9 shadow-2xl backdrop-blur-xl relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6 mb-8">
        ...
        <div className="flex items-center gap-2 text-xs">
          <span className="bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 px-3 py-1.5 rounded-xl font-bold flex items-center gap-1.5 shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center bg-slate-950 border border-slate-800 rounded-2xl p-5 sm:p-7 mb-8 shadow-xl">
          ...
          <div className="p-4 rounded-xl border border-emerald-500/40 bg-emerald-950/60 flex flex-col justify-between shadow-md">
            <div>
              ...
              <div className="text-2xl sm:text-3xl font-black text-white font-outfit flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-emerald-300 bg-emerald-900 border border-emerald-500/40 px-2 py-0.5 rounded-full">
                  INSTANT
                </span>
              </div>
      ...
      <div className="flex flex-col divide-y divide-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pb-4 text-xs uppercase tracking-wider text-slate-400 font-bold hidden md:grid">
          ...
          <div className="md:col-span-4 text-emerald-400">JOY Verification (The Modern Way)</div>
        </div>
        ...
        {COMPARISON_METRICS.map((row, idx) => {
          ...
          return (
            <div key={idx} className="py-4 sm:py-5 grid grid-cols-1 md:grid-cols-12 gap-4 items-start sm:items-center">
              ...
              {/* Traditional (Old Way) */}
              <div className="md:col-span-4 p-3 rounded-xl bg-slate-950/60 border border-rose-500/30 flex items-start gap-2.5">
              ...
              {/* JOY (Modern) */}
              <div className="md:col-span-4 p-3 rounded-xl bg-slate-950 border border-emerald-500/40 flex items-start gap-2.5 shadow-md">
      ...
      <div className="mt-8 pt-6 border-t border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a
          href="#roi-calculator"
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 font-black text-xs text-white flex items-center justify-center gap-2 transition-all shadow-md shadow-emerald-600/30 border border-emerald-400/50 cursor-pointer"
        >
