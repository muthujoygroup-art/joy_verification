...
export const FullJoiningFormModal = ({ candidate, isHrMode = false, onClose, onSubmitComplete }) => {
  ...
  const [formData, setFormData] = useState(() => {
    const defaults = {
      ...
      sec80cInvestment: jfd.sec80cInvestment || '150000',
      sec80dMediclaim: jfd.sec80dMediclaim || '25000',
      ...
      agreedContractFormXIII: jfd.agreedContractFormXIII !== undefined ? jfd.agreedContractFormXIII : true,
      ...
      accountNo: candidate?.accountNo || candidate?.bankAccountNo || jfd.accountNo || jfd.bankAccountNo || '501002349845',
      bankAccountNo: candidate?.bankAccountNo || jfd.bankAccountNo || '501002349845',
      ifscCode: candidate?.ifscCode || jfd.ifscCode || 'HDFC0000128',
      branchName: jfd.branchName || jfd.bankBranch || 'Koramangala 4th Block, Bengaluru',
      bankBranch: jfd.bankBranch || 'Koramangala 4th Block Branch, Bengaluru',
      accountType: jfd.accountType || 'Salary Account (Zero Balance)',

      // Section 4: Education Details (Multi-Entry)
      educationList: jfd.educationList || [
        { qualificationCategory: 'Under Graduate (UG / Bachelor)', degreeName: 'B.Tech in Computer Science & Engg', institutionName: 'PSG College of Technology, Coimbatore', university: 'Anna University', passingYear: '2020', grade: '8.75 CGPA (85.2%)', yearOfJoining: '2016', yearOfEnd: '2020' },
        { qualificationCategory: 'Higher Secondary (12th / HSC)', degreeName: 'Higher Secondary (12th Standard)', institutionName: 'St. Joseph Higher Secondary School, Madurai', university: 'State Board', passingYear: '2016', grade: '94.5% Distinction', yearOfJoining: '2014', yearOfEnd: '2016' },
        { qualificationCategory: 'Secondary School (10th / SSLC)', degreeName: 'Secondary School Leaving Certificate (10th)', institutionName: 'St. Joseph High School, Madurai', university: 'State Board', passingYear: '2014', grade: '96.0% Distinction', yearOfJoining: '2012', yearOfEnd: '2014' }
      ],
      ...
      familyNominees: jfd.familyNominees || [
        { nomineeName: 'Suresh Kumar P', relationship: 'Father', nomineeDob: '1965-08-12', nomineeAadhaar: '5489 9012 3412', sharePercent: '50', isEpfNominee: true, isEpsNominee: true, isGratuityNominee: true, isInsuranceNominee: true },
        { nomineeName: 'Meenakshi S', relationship: 'Mother', nomineeDob: '1970-04-20', nomineeAadhaar: '5489 8912 4589', sharePercent: '50', isEpfNominee: true, isEpsNominee: true, isGratuityNominee: true, isInsuranceNominee: true }
      ],
      ...
      experienceList: jfd.experienceList || [
        { companyName: 'Infosys Limited', institutionName: 'Infosys Limited', address: 'Electronics City, Phase 1, Hosur Road, Bengaluru', institutionAddress: 'Electronics City, Phase 1, Hosur Road, Bengaluru', role: 'Systems Engineer', designation: 'Systems Engineer', doj: '2021-06-01', doe: '2024-07-31', periodOfService: '06/2021 - 07/2024 (3 Yrs 2 Mos)', expYears: '3.1', salaryDrawn: '₹8,50,000 Per Annum (₹62,000/mo)', reasonForLeaving: 'Career advancement, higher architectural ownership, role alignment', leavingReason: 'Career advancement, higher architectural ownership, role alignment' }
      ],

      // Section 8: Health, Lifestyle & Background Disclosures (Conditional Yes/No)
      bloodGroup: jfd.bloodGroup || candidate?.bloodGroup || 'O+ Positive',
      heightCm: jfd.heightCm || '175',
      weightKg: jfd.weightKg || '68',
      identificationMark1: jfd.identificationMark1 || 'Mole on right collar bone',
      identificationMark2: jfd.identificationMark2 || 'Small scar on left knee',
      hasPreExistingIllness: jfd.hasPreExistingIllness || 'No',
      preExistingDetails: jfd.preExistingDetails || 'None',
      covidVaccineDoses: jfd.covidVaccineDoses || '2 Doses + Precautionary Booster (Covishield)',
      ...
      linkedInUrl: jfd.linkedInUrl || 'https://www.linkedin.com/in/muthu-kumar-p-software',
      githubUrl: jfd.githubUrl || 'https://github.com/muthukumar-dev',
      portfolioUrl: jfd.portfolioUrl || 'https://muthukumar.tech',
      twitterUrl: jfd.twitterUrl || 'https://twitter.com/muthukumar_p',
      ...
      uploadedDocuments: jfd.uploadedDocuments || candidate?.uploadedDocuments || {
        aadhaarDoc: { name: 'Aadhaar_Card_Front_Back_Verified.pdf', type: 'application/pdf', size: '420 KB', title: 'Aadhaar Card (UIDAI E-Aadhaar)' },
        panDoc: { name: 'PAN_Card_Permanent_Account_Proof.pdf', type: 'application/pdf', size: '310 KB', title: 'Permanent Account Number (PAN Card)' },
        cancelledChequeDoc: { name: 'HDFC_Bank_Salary_Cheque_Cancelled.pdf', type: 'application/pdf', size: '290 KB', title: 'Cancelled Cheque / Bank Statement Proof' },
        highestDegreeDoc: { name: 'NIT_Trichy_MTech_Degree_Certificate.pdf', type: 'application/pdf', size: '890 KB', title: 'Highest Educational Degree Certificate' },
        previousRelievingDoc: { name: 'Wipro_Relieving_Experience_Letter.pdf', type: 'application/pdf', size: '640 KB', title: 'Previous Employer Relieving & Service Letter' },
        ndaExecutedDoc: { name: 'JOY_Corporate_NonDisclosure_Agreement_Signed.pdf', type: 'application/pdf', size: '510 KB', title: 'Non-Disclosure Agreement (NDA Signed Copy)' }
      },
      ...
      industrySpecialization: {
        ...
        techStack: candSpec.techStack || candSpec.primaryTechStack || 'React, Node.js, Python, PostgreSQL, AWS',
        githubUrl: candSpec.githubUrl || candSpec.gitHubRepoUrl || 'https://github.com/developer-profile',
