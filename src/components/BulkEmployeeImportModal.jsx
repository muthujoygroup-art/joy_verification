...
export const BulkEmployeeImportModal = ({ 
  ...
  // 1. GENERATE & DOWNLOAD COMPREHENSIVE SECTOR TEMPLATES (60+ COMPREHENSIVE COLUMNS)
  const handleDownloadTemplate = (sector = selectedSectorTemplate, format = 'xlsx') => {
    ...
    const itSampleData = [
      {
        ...
        'Father Mobile Number': '9876543220',
        'Father Occupation': 'Retired Central Govt Officer',
        'Mother Name': 'Kanta Sharma',
        'Mother Mobile Number': '9876543221',
        'Mother Occupation': 'Homemaker',
        'Spouse Name': 'Ananya Sharma',
        'Spouse Mobile Number': '9876543222',
        'Spouse Occupation': 'Senior Product Designer',
        ...
        'Mother Tongue': 'Hindi',
        'Known Languages': 'English, Hindi, Kannada, Tamil',
        ...
        'Driving License Number': 'KA0120180004910',
        'Passport Number': 'Z2094812',
        'Voter ID Number': 'ABC1234567',
        'Ration Card Number': 'RC9845123019',
        'Bank Account Holder Name': 'Rahul Sharma',
        'Bank Name': 'HDFC Bank',
        'Account Number': '50100234129845',
        'IFSC Code': 'HDFC0000128',
        'Branch Name': 'Koramangala 4th Block',
        'LinkedIn Profile URL': 'https://linkedin.com/in/rahulsharma-dev',
        'GitHub Profile URL': 'https://github.com/rahulsharma',
        'Twitter / X Profile URL': 'https://x.com/rahulsharma',
        'Portfolio / Website URL': 'https://rahulsharma.dev'
      },
      {
        'Full Name *': 'Priya Patel',
        'Father / Spouse Name': 'Ramesh Patel',
        'Father Mobile Number': '9823456780',
        'Father Occupation': 'Business Owner',
        'Mother Name': 'Geeta Patel',
        'Mother Mobile Number': '9823456789',
        ...
        'Known Languages': 'English, Hindi, Gujarati, Marathi',
        ...
        'ESIC IP Number': '3194812091',
        'Driving License Number': 'MH1220190008123',
        'Passport Number': 'P1098451',
        'Voter ID Number': 'WXY9876543',
        'Ration Card Number': 'MH4110578819',
        'Bank Account Holder Name': 'Priya Patel',
        'Bank Name': 'ICICI Bank',
        'Account Number': '000401589234',
        'IFSC Code': 'ICIC0000004',
        'Branch Name': 'Hinjewadi Phase 1',
        'LinkedIn Profile URL': 'https://linkedin.com/in/priyapatel-tech',
        'GitHub Profile URL': 'https://github.com/priyapatel',
        'Twitter / X Profile URL': 'https://x.com/priyapatel_dev',
        'Portfolio / Website URL': 'https://priyapatel.dev'
      }
    ];
    ...
    const mfgSampleData = [
      {
        ...
        'Father Mobile Number': '9841234560',
        'Father Occupation': 'Senior Mechanic',
        'Mother Name': 'Lakshmi S',
        'Mother Mobile Number': '9841234561',
        'Mother Occupation': 'Homemaker',
        'Spouse Name': 'Kavitha Murugan',
        'Spouse Mobile Number': '9841234562',
        'Spouse Occupation': 'Tailor',
        ...
        'Marital Status': 'Married',
        'Mother Tongue': 'Tamil',
        'Known Languages': 'Tamil, English, Telugu',
        ...
        'EPFO UAN Number (12 Digits)': '100987654321',
        'Driving License Number': 'TN0220150009124',
        'Passport Number': '',
        'Voter ID Number': 'TNJ7788991',
        'Ration Card Number': 'TN02/104/09812',
    ...
    const bfsiSampleData = [
      {
        ...
        'Father Mobile Number': '9830123450',
        'Father Occupation': 'Professor of Economics',
        'Mother Name': 'Malati Sengupta',
        'Mother Mobile Number': '9830123451',
        'Mother Occupation': 'Bank Manager (Retd)',
        'Spouse Name': 'Dr. Arnab Banerjee',
        'Spouse Mobile Number': '9830123452',
        'Spouse Occupation': 'Surgeon',
        ...
        'Known Languages': 'English, Hindi, Bengali, German',
        ...
        'ESIC IP Number': '3190841298',
        'Driving License Number': 'MH0120170008912',
        'Passport Number': 'N9081234',
        'Voter ID Number': 'MHX8812903',
        'Ration Card Number': 'MH4000519921',
        'Bank Account Holder Name': 'Ananya Sengupta',
        'Bank Name': 'HDFC Bank',
        'Account Number': '00600159823412',
        'IFSC Code': 'HDFC0000060',
        'Branch Name': 'Fort Branch Mumbai',
        'LinkedIn Profile URL': 'https://linkedin.com/in/ananyasengupta-fin',
        'GitHub Profile URL': '',
        'Twitter / X Profile URL': 'https://x.com/ananyafin',
        'Portfolio / Website URL': ''
      }
    ];
    ...
    const healthSampleData = [
      {
        ...
        'Father Mobile Number': '9447123450',
        'Father Occupation': 'Planter',
        'Mother Name': 'Annamma Kurian',
        'Mother Mobile Number': '9447123451',
        'Mother Occupation': 'Nurse Supervisor (Retd)',
        'Spouse Name': 'Thomas Kurian',
        'Spouse Mobile Number': '9447123458',
        'Spouse Occupation': 'Healthcare Administrator',
        ...
        'Known Languages': 'English, Malayalam, Tamil, Hindi',
        ...
        'Specialization / Major': 'Critical Care Nursing',
        ...
        'Driving License Number': 'TN0620160004910',
        'Passport Number': 'M8819204',
        'Voter ID Number': 'TNX9918234',
        'Ration Card Number': 'TN06/201/04812',
        ...
        'LinkedIn Profile URL': 'https://linkedin.com/in/sistermarykurian',
        'GitHub Profile URL': '',
        'Twitter / X Profile URL': '',
        'Portfolio / Website URL': ''
      }
    ...
    const logSampleData = [
      {
        ...
        'Father Mobile Number': '9890123450',
        'Father Occupation': 'Farmer',
        'Mother Name': 'Phoolwati Yadav',
        'Mother Mobile Number': '9890123451',
        'Mother Occupation': 'Homemaker',
        'Spouse Name': 'Shanti Devi',
        'Spouse Mobile Number': '9890123452',
        ...
        'Marital Status': 'Married',
        'Mother Tongue': 'Hindi',
        'Known Languages': 'Hindi, Bhojpuri, Marathi',
        ...
        'Driving License Number': 'MH0420150009812',
        'Passport Number': '',
        'Voter ID Number': 'UPX8829104',
        'Ration Card Number': 'UP2760019481',
    ...
    const guideData = [
      { 'Field Name': 'Full Name *', 'Mandatory': 'YES', 'Section': '1. Personal Information', 'Allowed Values': 'Legal candidate name as per Aadhaar / PAN', 'Notes': 'Primary key for verification certificates' },
      ...
      { 'Field Name': 'Date of Birth (YYYY-MM-DD)', 'Mandatory': 'NO', 'Section': '1. Personal Information', 'Allowed Values': 'YYYY-MM-DD (e.g. 1996-05-15)', 'Notes': 'Required for MoRTH Driving License & Passport checks' },
      { 'Field Name': 'Father / Mother / Spouse Names & Contacts', 'Mandatory': 'NO', 'Section': '1. Family Background', 'Allowed Values': 'Full Name, 10-digit Phone, Occupation', 'Notes': 'Enriches complete employee profile background' },
      { 'Field Name': 'Known Languages', 'Mandatory': 'NO', 'Section': '1. Personal Information', 'Allowed Values': 'Comma-separated (e.g. English, Hindi, Tamil)', 'Notes': 'Candidate linguistic capabilities' },
      { 'Field Name': 'Aadhaar Number (12 Digits)', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': '12-digit Indian UID (e.g. 234567890123)', 'Notes': 'Pre-fills UIDAI OTP e-KYC gate' },
      { 'Field Name': 'PAN Card Number (10 Digits)', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': '10-character alphanumeric PAN (e.g. ABCDE1234F)', 'Notes': 'Pre-fills NSDL 2.0 direct verification' },
      { 'Field Name': 'EPFO UAN Number (12 Digits)', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': '12-digit EPFO UAN (e.g. 101298450123)', 'Notes': 'Enables dual employment & moonlighting audit' },
      ...
      { 'Field Name': 'Driving License Number', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': 'MoRTH Sarathi DL Code (e.g. KA0120200004910)', 'Notes': 'Transport & logistics fleet verification' },
      { 'Field Name': 'Passport Number', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': '8-character alphanumeric Indian Passport Number', 'Notes': 'Ministry of External Affairs Passport direct check' },
      { 'Field Name': 'Voter ID / EPIC Number', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': '10-char EPIC code (e.g. ABC1234567)', 'Notes': 'Election Commission of India Electoral verification' },
      { 'Field Name': 'Ration Card Number', 'Mandatory': 'NO', 'Section': '5. Statutory KYC', 'Allowed Values': 'State Food & Civil Supplies ration number', 'Notes': 'National Food Security statutory record' },
      ...
      { 'Field Name': 'Social Media Profiles', 'Mandatory': 'NO', 'Section': '9. Online Footprint', 'Allowed Values': 'LinkedIn, GitHub, Twitter/X, Portfolio URLs', 'Notes': 'Digital professional presence verification' }
    ];
    ...
    const setColWidths = (ws) => {
      ws['!cols'] = [
        { wch: 24 }, { wch: 22 }, { wch: 18 }, { wch: 24 }, { wch: 20 }, 
        { wch: 18 }, { wch: 24 }, { wch: 20 }, { wch: 18 }, { wch: 24 }, 
        { wch: 18 }, { wch: 8 },  { wch: 10 }, { wch: 12 }, { wch: 14 }, 
        { wch: 14 }, { wch: 26 }, { wch: 28 }, { wch: 18 }, { wch: 18 }, 
        { wch: 22 }, { wch: 18 }, { wch: 16 }, { wch: 32 }, { wch: 16 }, 
        { wch: 18 }, { wch: 14 }, { wch: 32 }, { wch: 16 }, { wch: 18 }, 
        { wch: 14 }, { wch: 18 }, { wch: 28 }, { wch: 26 }, { wch: 18 }, 
        { wch: 26 }, { wch: 20 }, { wch: 18 }, { wch: 18 }, { wch: 30 }, 
        { wch: 26 }, { wch: 26 }, { wch: 26 }, { wch: 14 }, { wch: 14 }, 
        { wch: 14 }, { wch: 26 }, { wch: 24 }, { wch: 18 }, { wch: 16 }, 
        { wch: 18 }, { wch: 20 }, { wch: 20 }, { wch: 18 }, { wch: 20 }, 
        { wch: 18 }, { wch: 18 }, { wch: 20 }, { wch: 24 }, { wch: 20 }, 
        { wch: 22 }, { wch: 16 }, { wch: 22 }, { wch: 30 }, { wch: 30 }, 
        { wch: 26 }, { wch: 26 }
      ];
    };
  ...
  const handleExecuteBulkImport = async () => {
    ...
    const candidatePayloads = candidatesToImport.map((row, idx) => {
      ...
      return {
        ...
        pan_no: row.pan,
        aadhaarNo: row.aadhaar,
        aadhaar_no: row.aadhaar,
        pfNumber: row.uanEpf,
        uanNumber: row.uanEpf,
        uan_no: row.uanEpf,
        uanEpf: row.uanEpf,
        esiNumber: row.esicNo,
        esi_number: row.esicNo,
        esicNo: row.esicNo,
        bankAccountNo: row.bankAccountNo,
        accountNumber: row.bankAccountNo,
        bank_account_no: row.bankAccountNo,
        ifscCode: row.bankIfsc,
        ifsc_code: row.bankIfsc,
        bankName: row.bankName,
        bank_name: row.bankName,
        accountHolderName: row.bankAccountHolder || row.name,
        dlNumber: row.drivingLicense,
        drivingLicense: row.drivingLicense,
        passportNo: row.passportNo,
        voterId: row.voterId || row.epic_number || '',
        fatherName: row.fatherSpouseName,
        father_name: row.fatherSpouseName,
        motherName: row.motherName,
        mother_name: row.motherName,
        permanentAddress: row.permanentAddressLine,
        permanent_address: row.permanentAddressLine,
        presentAddress: row.presentAddressLine || row.permanentAddressLine,
        present_address: row.presentAddressLine || row.permanentAddressLine,
