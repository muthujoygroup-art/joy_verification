        ...
        <table className="w-full border border-slate-800 text-[10px] text-left">
          ...
          <tbody className="divide-y divide-slate-800 bg-white">
            <tr className="divide-x divide-slate-800">
              ...
              <td className="p-1.5 text-slate-700">{nomineeAddr}</td>
              <td className="p-1.5 font-bold">{nomineeRel}</td>
              <td className="p-1.5 font-mono">{nomineeDob}</td>
              <td className="p-1.5 font-bold font-mono text-emerald-800">{nomineeShare}</td>
              <td className="p-1.5 text-slate-400">{nomineeGuardian}</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="w-full border border-slate-800 text-[10px] text-left">
          ...
          <tbody className="divide-y divide-slate-800 bg-white">
            <tr className="divide-x divide-slate-800">
              ...
              <td className="p-1.5 font-bold font-mono">{nomineeName} ({nomineeAddr})</td>
              <td className="p-1.5 text-center font-mono">{nomineeAge}</td>
              <td className="p-1.5 font-bold">{nomineeRel}</td>
            </tr>
          </tbody>
        </table>
