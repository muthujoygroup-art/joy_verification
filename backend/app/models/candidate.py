...
class Candidate(Base):
    ...
    spouse_mobile = Column(String(50), nullable=True)
    spouse_occupation = Column(String(100), nullable=True)
    siblings = Column(JSON, default=list)
    ...
    qualification_category = Column(String(100), nullable=True)
    ...
    nominee_name = Column(String(150), nullable=True)
