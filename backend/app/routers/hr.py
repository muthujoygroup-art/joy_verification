...
def _save_or_update_candidate_record(payload: CandidateCreate, db: Session, commit: bool = True):
    ...
    new_candidate = Candidate(
        ...
        gender=payload.gender or joining_data.get("gender") or None,
        marital_status=payload.marital_status or joining_data.get("maritalStatus") or None,
        mother_tongue=payload.mother_tongue or joining_data.get("motherTongue") or None,
        languages_known=payload.languages_known or joining_data.get("languagesKnown") or None,
        pf_number=uan_val,
        esi_number=esi_val,
        religion=payload.religion or joining_data.get("religion") or None,
        caste=payload.caste or joining_data.get("caste") or None,
        category=payload.category or joining_data.get("category") or "General",
        native_state=payload.native_state or joining_data.get("nativeState") or None,
        ...
        city=payload.city or joining_data.get("permanentCity") or None,
        area=payload.area or joining_data.get("area") or None,
        pincode=payload.pincode or joining_data.get("permanentPincode") or None,
        ...
        qualification_category=payload.qualification_category or joining_data.get("qualificationCategory") or None,
        highest_qualification=payload.highest_qualification or joining_data.get("highestQualification") or None,
        job_category=payload.job_category or joining_data.get("jobCategory") or None,
        job_type=payload.job_type or joining_data.get("jobType") or "Full Time Permanent",
        bank_name=bank_name_val,
        bank_account_no=bank_acc_val,
        ifsc_code=ifsc_val,
        nominee_name=payload.nominee_name or joining_data.get("nomineeName") or None,
        nominee_relation=payload.nominee_relation or joining_data.get("nomineeRelation") or None,
        linked_in_url=payload.linked_in_url or joining_data.get("linkedInUrl") or None,
        ...
        specimen_signature=payload.specimen_signature or joining_data.get("specimenSignature") or None,
